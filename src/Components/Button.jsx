...
const Button = ({ label, variant = "light" }) => {
  const baseStyles =
    "px-6 py-2 rounded-full flex items-center justify-center gap-2 font-bold transition-all duration-300 cursor-pointer";

  const variants = {
    light: "bg-white text-black-1 border border-gray-300 hover:bg-gray-100 cursor-pointer",
